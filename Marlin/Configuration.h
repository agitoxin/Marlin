...
#define STRING_CONFIG_H_AUTHOR "edit: XUE v0.1" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,800*0.95}  // default steps per unit for Ultimaker
