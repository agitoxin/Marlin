...
#define STRING_CONFIG_H_AUTHOR "edit: XUE (ATO SERVO Z)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 STRING_CONFIG_H_AUTHOR
...
#define CUSTOM_MACHINE_NAME "SHIH's RP"
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -10.65  // Z probe to nozzle Z offset: -below (always!)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,800*0.9}  // default steps per unit for Ultimaker
